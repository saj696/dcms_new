...
class Municipal_ward_create extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        parent::__construct();
        $this->message='';
        $this->permissions=Menu_helper::get_permission('basic_setup/municipal_ward_create');
        if($this->permissions)
        {
        ...
        $this->controller_url='basic_setup/municipal_ward_create';
        $this->load->model("basic_setup/municipal_ward_create_model");
    ...
    private function system_list()
    {
        if($this->permissions['list'])
        {
            ...
            $ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("basic_setup/municipal_ward_create/list","",true));

            if($this->message)
            {
                $ajax['system_message']=$this->message;
            }
            $ajax['system_page_url']=$this->get_encoded_url('basic_setup/municipal_ward_create');
            $ajax['system_page_title']=$this->lang->line("MUNICIPAL_CREATE_WARD_TITLE");
    ...
    private function system_add()
    {
        ...
        if($this->permissions['add'])
        {
            ...
            $ajax['system_page_url']=$this->get_encoded_url('basic_setup/municipal_ward_create/index/add');
            $this->jsonReturn($ajax);
        }
        else
        {
    ...
    public function get_list()
    {
        ...
        if($this->permissions['list'])
        {
            $divisions = $this->municipal_ward_create_model->get_record_list();
        }
