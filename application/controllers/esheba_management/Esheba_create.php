...
class Esheba_create extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        ...
        parent::__construct();
        $this->message='';
        $this->permissions=Menu_helper::get_permission('esheba_management/Esheba_create');
        $this->controller_url='esheba_management/Esheba_create';
        $this->load->model("esheba_management/Esheba_create_model");
    ...
    private function system_list()
    {
        if($this->permissions['list'])
        {
            ...
            $ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("esheba_management/esheba_create/list","",true));

            if($this->message)
            {
                $ajax['system_message']=$this->message;
            }
            $ajax['system_page_url']=$this->get_encoded_url('esheba_management/Esheba_create');
    ...
    private function system_add()
    {
        if($this->permissions['add'])
        {
            ...
            $ajax['system_content'][]=array("id"=>"#system_wrapper_top_menu","html"=>$this->load_view("top_menu","",true));
            $ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("esheba_management/esheba_create/add_edit",$data,true));
            ...
            $ajax['system_page_url']=$this->get_encoded_url('esheba_management/esheba_create/index/add');
            $this->jsonReturn($ajax);
        }
        else
        {
    ...
    private function system_edit($id)
    {
        if($this->permissions['edit'])
        {
            ...
            $ajax['system_page_url']=$this->get_encoded_url('esheba_management/esheba_create/index/edit/'.$id);
            $this->jsonReturn($ajax);
        }
        else
        {
    ...
    private function system_save()
    {
        ...
        else
        {
            ...
            //$service_detail['status']=$service_detail['status'];
            if($id>0)
            {
    ...
    private function check_validation()
    {
        ...
        */
        if($this->input->post("service_detail[status]")==$this->config->item('STATUS_INACTIVE'))
        {
            if($this->Esheba_create_model->check_esheba_status($this->input->post('id')))
            {
    ...
    public function get_list()
    {
        ...
        if($this->permissions['list'])
        {
            $divisions = $this->Esheba_create_model->get_record_list();
        }
