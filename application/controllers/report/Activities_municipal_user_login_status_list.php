...
class Activities_municipal_user_login_status_list extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        parent::__construct();
        $this->message='';
        $this->permissions=Menu_helper::get_permission('report/activities_municipal_user_login_status_list');
        $this->controller_url='report/activities_municipal_user_login_status_list';
        $this->lang->load("report", $this->get_language());
        //$this->load->model("basic_setup/activities_municipal_user_login_status_list_model");
    ...
    public function index()
    {
        ...
        $ajax['status']=true;
        $data['title']=$this->lang->line("REPORT_MUNICIPAL_USER_ACTIVITIES_LOGIN_STATUS_TITLE");

        $ajax['system_content'][]=array("id"=>"#system_wrapper_top_menu","html"=>$this->load_view("top_menu","",true));
        $ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("report/activities_municipal_user_login_status_list",$data,true));
        $ajax['system_page_url']=$this->get_encoded_url('report/activities_municipal_user_login_status_list');
