...
class Country_wise_city_corporation_monthly_income_list extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        parent::__construct();
        $this->message='';
        $this->permissions=Menu_helper::get_permission('report/country_wise_city_corporation_monthly_income_list');
        $this->controller_url='report/country_wise_city_corporation_monthly_income_list';
        $this->lang->load("report", $this->get_language());
        //$this->load->model("basic_setup/country_wise_city_corporation_monthly_income_list_model");
