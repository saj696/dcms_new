...
class Country_wise_city_corporation_monthly_income_report extends CI_Controller
{
    public $permissions;
    ...
    private function report_list($format="")
    {
        if($format!="pdf")
        {
            ...
            $data['report_lists']=$this->uisc_registration_model->get_country_wise_city_corporation_monthly_income_info($from_date, $to_date,$division,$zilla,$city_corporation,$city_corporation_ward);
//            echo '<pre>';
//            print_r($data['report_lists']);
//            echo '</pre>';
//            die;
            $this->load->view('default/report/country_wise_city_corporation_monthly_income_report',$data);
        }
        else
        {
