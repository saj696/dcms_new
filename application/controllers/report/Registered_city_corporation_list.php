...
class Registered_city_corporation_list extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        parent::__construct();
        $this->message='';
        $this->permissions=Menu_helper::get_permission('report/registered_city_corporation_list');
        $this->controller_url='report/registered_city_corporation_list';
        $this->lang->load("report", $this->get_language());
        //$this->load->model("basic_setup/registered_city_corporation_list_model");
    ...
    public function index()
    {
        ...
        $ajax['status']=true;
        $data['title']=$this->lang->line("REPORT_UISC_REGISTRATION_CITY_CORPORATION_TITLE");

        $ajax['system_content'][]=array("id"=>"#system_wrapper_top_menu","html"=>$this->load_view("top_menu","",true));
        $ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("report/registered_city_corporation_list",$data,true));
        $ajax['system_page_url']=$this->get_encoded_url('report/registered_city_corporation_list');
