...
class Registered_municipal_user_list extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        parent::__construct();
        $this->message='';
        $this->permissions=Menu_helper::get_permission('report/registered_municipal_user_list');
        $this->controller_url='report/registered_municipal_user_list';
        $this->lang->load("report", $this->get_language());
        //$this->load->model("basic_setup/registered_municipal_user_list_model");
    ...
    public function index()
    {
        ...
        $ajax['status']=true;
        $data['title']=$this->lang->line("REPORT_UISC_REGISTRATION_MUNICIPAL_USER_TITLE");

        $ajax['system_content'][]=array("id"=>"#system_wrapper_top_menu","html"=>$this->load_view("top_menu","",true));
        $ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("report/registered_municipal_user_list",$data,true));
        $ajax['system_page_url']=$this->get_encoded_url('report/registered_municipal_user_list');
