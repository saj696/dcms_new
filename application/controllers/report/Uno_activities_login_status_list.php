...
class Uno_activities_login_status_list extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        parent::__construct();
        $this->message='';
        $this->permissions=Menu_helper::get_permission('report/uno_activities_login_status_list');
        $this->controller_url='report/uno_activities_login_status_list';
        $this->lang->load("report", $this->get_language());
        //$this->load->model("basic_setup/uno_activities_login_status_list_model");
    ...
    public function index()
    {
        ...
        $ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("report/uno_activities_login_status_list",$data,true));
        $ajax['system_page_url']=$this->get_encoded_url('report/uno_activities_login_status_list');
