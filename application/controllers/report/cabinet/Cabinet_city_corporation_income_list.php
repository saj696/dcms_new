...
class Cabinet_city_corporation_income_list extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        parent::__construct();
        $this->message='';
        $this->permissions=Menu_helper::get_permission('report/cabinet/cabinet_city_corporation_income_list');
        $this->controller_url='report/cabinet/cabinet_city_corporation_income_list';
        $this->lang->load("report", $this->get_language());
        //$this->load->model("basic_setup/cabinet/cabinet_city_corporation_income_list_model");
    ...
    public function index()
    {
        ...
        $ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("report/cabinet/cabinet_city_corporation_income_list",$data,true));
        $ajax['system_page_url']=$this->get_encoded_url('report/cabinet/cabinet_city_corporation_income_list');
