...
class Cabinet_service_holder_income_report_view extends CI_Controller
{
    public $permissions;
    ...
    private function report_list($format="")
    {
        if($format!="pdf")
        {
            ...
            if(!empty($status) && $this->input->get('report_type')==$this->config->item('ONLINE_UNION_GROUP_ID'))
            {
                ...
                $data['report']=$this->cabinet_report_model->get_cabinet_union_service_holder_income($division, $zilla, $upazila, $union, $from_date, $to_date, $status);
                $this->load->view('default/report/cabinet/cabinet_union_service_holder_income_report',$data);
            }
            else if(!empty($status) && $this->input->get('report_type')==$this->config->item('ONLINE_CITY_CORPORATION_WORD_GROUP_ID'))
            {
                ...
                $data['report']=$this->cabinet_report_model->get_cabinet_city_corporation_service_holder_income($division, $zilla, $city_corporation, $city_corporation_ward, $from_date, $to_date, $status);
                $this->load->view('default/report/cabinet/cabinet_city_corporation_service_holder_income_report',$data);
            }
            else if(!empty($status) && $this->input->get('report_type')==$this->config->item('ONLINE_MUNICIPAL_WORD_GROUP_ID'))
            {
                ...
                $data['report']=$this->cabinet_report_model->get_cabinet_municipal_service_holder_income($division, $zilla, $municipal, $municipal_ward, $from_date, $to_date, $status);
            ...
            else
            {
                ...
                $data['report']='';
                $this->load->view('default/report/cabinet/cabinet_service_holder_income_report_view',$data);
            }
        }
        else
        {
            ...
            if(!empty($status) && $this->input->get('report_type')==$this->config->item('ONLINE_UNION_GROUP_ID'))
            {
                ...
                $union=$this->input->get('union');
                $data['report']=$this->cabinet_report_model->get_cabinet_union_service_holder_income($division, $zilla, $upazila, $union, $from_date, $to_date, $status);
                $html = $this->load->view('default/report/cabinet/cabinet_union_service_holder_income_report',$data, true);
            }
            else if(!empty($status) && $this->input->get('report_type')==$this->config->item('ONLINE_CITY_CORPORATION_WORD_GROUP_ID'))
            {
                $data['title']=$this->lang->line("REPORT_UPLOAD_REPORT_CITY_CORPORATION_TITLE");
                ...
                $city_corporation_ward=$this->input->get('city_corporation_ward');
                $data['report']=$this->cabinet_report_model->get_cabinet_city_corporation_service_holder_income($division, $zilla, $city_corporation, $city_corporation_ward, $from_date, $to_date, $status);
                $html = $this->load->view('default/report/cabinet/cabinet_city_corporation_service_holder_income_report',$data, true);
            }
            else if(!empty($status) && $this->input->get('report_type')==$this->config->item('ONLINE_MUNICIPAL_WORD_GROUP_ID'))
            {
                $data['title']=$this->lang->line("REPORT_UPLOAD_REPORT_MUNICIPAL_TITLE");
            ...
            else
            {
                $data['title']=$this->lang->line("REPORT_UPLOAD_REPORT_TITLE");
                $data['report']='';
                $html = $this->load->view('default/report/cabinet/cabinet_service_holder_income_report_view',$data, true);
            }
