...
class Cabinet_union_service_holder_income_list extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        parent::__construct();
        $this->message='';
        $this->permissions=Menu_helper::get_permission('report/cabinet/cabinet_union_service_holder_income_list');
        //$this->controller_url='report/upload_report_model';
        $this->lang->load("report", $this->get_language());
        //$this->load->model("basic_setup/cabinet/cabinet_union_service_holder_income_list_model");
    }
    ...
    public function index()
    {
        ...
        $ajax['status']=true;
        //$data['title']=$this->lang->line("REPORT_CABINET_UNION_SERVICE_HOLDER_INCOME_TITLE");
        //$ajax['system_content'][]=array("id"=>"#system_wrapper_top_menu","html"=>$this->load_view("top_menu","",true));
        $ajax['system_content'][]=array("id"=>"#go_location","html"=>$this->load_view("report/cabinet/cabinet_union_service_holder_income_list",$data,true));
        //$ajax['system_page_url']=$this->get_encoded_url('report/cabinet/cabinet_union_service_holder_income_list');
