...
class Digital_center_info_city_corporation_list extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        parent::__construct();
        $this->message='';
        $this->permissions=Menu_helper::get_permission('report/digital_center/digital_center_info_city_corporation_list');
        $this->controller_url='report/digital_center/digital_center_info_city_corporation_list';
    ...
    public function index()
    {
        ...
        $ajax['system_content'][]=array("id"=>"#go_location","html"=>$this->load_view("report/digital_center/digital_center_info_city_corporation_list",$data,true));
