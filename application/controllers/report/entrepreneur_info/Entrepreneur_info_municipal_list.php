...
class Entrepreneur_info_municipal_list extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        parent::__construct();
        $this->message='';
        $this->permissions=Menu_helper::get_permission('report/entrepreneur_info/entrepreneur_info_municipal_list');
        //$this->controller_url='report/entrepreneur_info/entrepreneur_info_municipal_list';
        $this->lang->load("report", $this->get_language());
        //$this->load->model("basic_setup/entrepreneur_info/entrepreneur_info_municipal_list_model");
    ...
    public function index()
    {
        ...
        $ajax['system_content'][]=array("id"=>"#go_location","html"=>$this->load_view("report/entrepreneur_info/entrepreneur_info_municipal_list",$data,true));
        //$ajax['system_page_url']=$this->get_encoded_url('report/entrepreneur_info/entrepreneur_info_municipal_list');
