...
class Entrepreneur_info_report_view extends CI_Controller
{
    public $permissions;
    ...
    private function report_list($format="")
    {
        if($format!="pdf")
        {
            ...
            if($this->input->get('report_type')==$this->config->item('ONLINE_UNION_GROUP_ID'))
            {
                ...
                $data['report']=$this->entrepreneur_info_report_model->get_entrepreneur_info_union($division, $zilla, $upazila, $union);
                $this->load->view('default/report/entrepreneur_info/entrepreneur_info_union_report',$data);
            }
            else if($this->input->get('report_type')==$this->config->item('ONLINE_CITY_CORPORATION_WORD_GROUP_ID'))
            {
                ...
                $this->load->view('default/report/entrepreneur_info/entrepreneur_info_city_corporation_report',$data);
            }
            else if($this->input->get('report_type')==$this->config->item('ONLINE_MUNICIPAL_WORD_GROUP_ID'))
            {
                ...
                $this->load->view('default/report/entrepreneur_info/entrepreneur_info_municipal_report',$data);
            }
            else
            {
                $data['title']=$this->lang->line("REPORT_ENTREPRENEUR_INFO_TITLE");
                $data['report']='';
                $this->load->view('default/report/entrepreneur_info/entrepreneur_info_report_view',$data);
            }
        }
        else
        {
            ...
            if($this->input->get('report_type')==$this->config->item('ONLINE_UNION_GROUP_ID'))
            {
                ...
                $union=$this->input->get('union');
                $data['report']=$this->entrepreneur_info_report_model->get_entrepreneur_info_union($division, $zilla, $upazila, $union);
                $html=$this->load->view('default/report/entrepreneur_info/entrepreneur_info_union_report',$data,true);
            }
            else if($this->input->get('report_type')==$this->config->item('ONLINE_CITY_CORPORATION_WORD_GROUP_ID'))
            {
                $data['title']=$this->lang->line("REPORT_ENTREPRENEUR_INFO_TITLE");
                ...
                $city_corporation_ward=$this->input->get('city_corporation_ward');
                $data['report']=$this->entrepreneur_info_report_model->get_entrepreneur_info_city_corporation($division, $zilla, $city_corporation, $city_corporation_ward);
                $html=$this->load->view('default/report/entrepreneur_info/entrepreneur_info_city_corporation_report',$data,true);
            }
            else if($this->input->get('report_type')==$this->config->item('ONLINE_MUNICIPAL_WORD_GROUP_ID'))
            {
                $data['title']=$this->lang->line("REPORT_ENTREPRENEUR_INFO_TITLE");
                ...
                $municipal_ward=$this->input->get('municipal_ward');
                $data['report']=$this->entrepreneur_info_report_model->get_entrepreneur_info_municipal($division, $zilla, $municipal, $municipal_ward);
                $html=$this->load->view('default/report/entrepreneur_info/entrepreneur_info_municipal_report',$data,true);
            }
            else
            {
                $data['title']=$this->lang->line("REPORT_ENTREPRENEUR_INFO_TITLE");
                $data['report']='';
                $html=$this->load->view('default/report/entrepreneur_info/entrepreneur_info_report_view',$data,true);
            }
