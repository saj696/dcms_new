...
class Dcms_equipment_info_municipal_list extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        parent::__construct();
        $this->message='';
        $this->permissions=Menu_helper::get_permission('report/equipment/dcms_equipment_info_municipal_list');
    ...
    public function index()
    {
        ...
        $ajax['system_content'][]=array("id"=>"#go_location","html"=>$this->load_view("report/equipment/dcms_equipment_info_municipal_list",$data,true));
