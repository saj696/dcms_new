...
class Upload_income_report_municipal_report extends CI_Controller
{
    public $permissions;
    ...
    private function report_list($format="")
    {
        if($format!="pdf")
        {
            ...
            $data['report']=$this->upload_report_model->get_municipal_report_upload_income($division, $zilla, $municipal, $municipal_ward, $from_date, $to_date);
        ...
        else
        {
            ...
            $data['to_date']=$to_date;
            $data['report']=$this->upload_report_model->get_municipal_report_upload_income($division, $zilla, $municipal, $municipal_ward, $from_date, $to_date);
            $html=$this->load->view('default/report/upload_income/upload_income_report_municipal_report',$data,true);
            //echo $html;
