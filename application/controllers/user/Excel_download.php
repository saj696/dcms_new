...
class Excel_download extends CI_Controller
{
    ...
    {
        $this->load->model("user/Service_template_model");
        $service_holder=$this->lang->line('MALE_VAL').",".$this->lang->line('FEMALE_VAL').",".$this->lang->line('TRIBE_VAL').",".$this->lang->line('DISABILITY_VAL');
        ...
        //$objPHPExcel->getActiveSheet()->setTitle('Report_Template');
        ...
        {
            //$service_list[]=$value['service_name'];
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M'.$sl, $value['service_name']);
            ++$sl;
        }
        ...
        //            $objValidation->setFormula1('"' . $service . '"');
            ...
            $objValidation->setFormula1('Worksheet!$M$1:$M$'.$sl);
            ...
            $objValidation2->setFormula1('"'.$service_holder.'"');
        }
