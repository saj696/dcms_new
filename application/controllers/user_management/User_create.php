...
class User_create extends Root_Controller
{
    ...
    private function system_add()
    {
        ...
        if($this->permissions['add'])
        {
            ...
            $this->db->where('id !='.$this->config->item('UISC_GROUP_ID'));
    ...
    private function system_edit($id)
    {
        if($this->permissions['edit'])
        {
            ...
            //$data['groups']=Query_helper::get_info($this->config->item('table_user_group'),array("concat_ws('~', id, level) value",'name_'.$this->get_language_code().' text'),array('status !=99'), 12);
            $data['divisions']=Query_helper::get_info($this->config->item('table_divisions'),array('divid value', 'divname text'), array());
    ...
    private function system_save()
    {
        ...
        else
        {
            ...
            else if($user_group_level == $this->config->item('DIVISION_GROUP_ID'))
            {
                $userDetail['zilla']='';
                $userDetail['upazila']='';
                $userDetail['unioun']='';
            ...
            else if($user_group_level == $this->config->item('DISTRICT_GROUP_ID'))
            {
                $userDetail['upazila']='';
                $userDetail['unioun']='';
                $userDetail['citycorporation']='';
            ...
            else if($user_group_level == $this->config->item('UPAZILLA_GROUP_ID'))
            {
                $userDetail['unioun']='';
                $userDetail['citycorporation']='';
                $userDetail['citycorporationward']='';
            ...
            else if($user_group_level == $this->config->item('UNION_GROUP_ID'))
            {
                $userDetail['citycorporation']='';
                $userDetail['citycorporationward']='';
                $userDetail['municipal']='';
            ...
            else if($user_group_level == $this->config->item('CITY_CORPORATION_GROUP_ID'))
            {
                $userDetail['citycorporationward']='';
                $userDetail['municipal']='';
                $userDetail['municipalward']='';
            ...
            else if($user_group_level == $this->config->item('CITY_CORPORATION_WORD_GROUP_ID'))
            {
                $userDetail['municipal']='';
                $userDetail['municipalward']='';
                $userDetail['uisc_id']=0;
            }
            else if($user_group_level == $this->config->item('MUNICIPAL_GROUP_ID'))
            {
                $userDetail['municipalward']='';
                $userDetail['uisc_id']=0;
            }
            else if($user_group_level == $this->config->item('MUNICIPAL_WORD_GROUP_ID'))
            {
                $userDetail['uisc_id']=0;
            }
