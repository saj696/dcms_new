...
class Home extends CI_Controller
{
    ...
    public function get_top_income_yesterday()
    {
        ...
        //$ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("website/home/yesterday_top_income",$data,true));
        //$ajax['system_page_url']=$this->get_encoded_url('website/home/get_top_income_yesterday');
        //$this->jsonReturn($ajax);
    }
    ...
    public function get_top_service_last_seven_days()
    {
        ...
        //$ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("website/home/last_seven_day_service_provider",$data,true));
        //$ajax['system_page_url']=$this->get_encoded_url('website/home/get_top_service_last_seven_days');
        //$this->jsonReturn($ajax);
    }
    ...
    public function get_top_income_last_seven_days()
    {
        ...
        //$ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("website/home/last_seven_day_top_income",$data,true));
        //$ajax['system_page_url']=$this->get_encoded_url('website/home/get_top_income_last_seven_days');
        //$this->jsonReturn($ajax);
    }
    ...
    public function get_top_service_last_month()
    {
        ...
        //$ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("website/home/last_month_top_service_provider",$data,true));
        //$ajax['system_page_url']=$this->get_encoded_url('website/home/get_top_service_last_month');
        //$this->jsonReturn($ajax);
    }
    ...
    public function get_top_income_last_month()
    {
        ...
        //$ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("website/home/last_month_top_income",$data,true));
        //$ajax['system_page_url']=$this->get_encoded_url('website/home/get_top_income_last_month');
        //$this->jsonReturn($ajax);
    }
