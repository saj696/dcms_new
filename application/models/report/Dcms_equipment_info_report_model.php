...
class Dcms_equipment_info_report_model extends CI_Model
{
    ...
    public function get_dcms_equipment_info_union($division, $zilla, $upazila, $union)
    {
        $CI = & get_instance();
        if (!empty($division))
        {
        ...
        $this->db->join($CI->config->item('table_uisc_resources')." uisc_resources",'uisc_resources.uisc_id = uisc_infos.id', 'LEFT');
        $this->db->join($CI->config->item('table_resources')." resources",'resources.res_id = uisc_resources.res_id', 'LEFT');
        ...
        for($i=0; $i<sizeof($result); $i++)
        {
            ...
            $result_array[$result[$i]['divid']]['zilla'][$result[$i]['zillaid']]['upazilla'][$result[$i]['upazilaid']]['union'][$result[$i]['unionid']]['uisc'][$result[$i]['uisc_id']]['equipment_info'][]=array
            (
                'equipment_name'=>$result[$i]['res_name'],
                'equipment_detail'=>$result[$i]['res_detail'],
                'equipment_quantity'=>$result[$i]['quantity'],
                'equipment_status'=>$result[$i]['status'],
            );
        }
    ...
    public function get_dcms_equipment_info_city_corporation($division, $zilla, $city_corporation, $city_corporation_ward)
    {
        ...
        for($i=0; $i<sizeof($result); $i++)
        {
            ...
            $result_array[$result[$i]['divid']]['zilla'][$result[$i]['zillaid']]['city_corporation'][$result[$i]['citycorporationid']]['city_corporation_ward'][$result[$i]['citycorporationwardid']]['uisc'][$result[$i]['uisc_id']]['equipment_info'][]=array
            (
                'equipment_name'=>$result[$i]['res_name'],
                'equipment_detail'=>$result[$i]['res_detail'],
                'equipment_quantity'=>$result[$i]['quantity'],
    ...
    public function get_dcms_equipment_info_municipal($division, $zilla, $municipal, $municipal_ward)
    {
        $CI = & get_instance();
        ...
        for($i=0; $i<sizeof($result); $i++)
        {
            ...
            $result_array[$result[$i]['divid']]['zilla'][$result[$i]['zillaid']]['municipal'][$result[$i]['municipalid']]['municipal_ward'][$result[$i]['wardid']]['uisc'][$result[$i]['uisc_id']]['equipment_info'][]=array
            (
                'equipment_name'=>$result[$i]['res_name'],
                'equipment_detail'=>$result[$i]['res_detail'],
                'equipment_quantity'=>$result[$i]['quantity'],
