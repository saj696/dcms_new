...
class Uisc_registration_model extends CI_Model
{
    ...
    public function get_country_wise_union_monthly_income_info($start_date, $end_date,$division,$zilla,$upazila,$union)
    {
        if (!empty($division))
        {
            $this->db->where('divisions.divid',$division);
        ...
        $this->db->select("
                            ...
                            ");
        $this->db->from($this->config->item('table_invoice').' invoices');
        $this->db->join($this->config->item('table_divisions').' divisions','divisions.divid = invoices.divid', 'LEFT');
        $this->db->join($this->config->item('table_zillas').' zillas','zillas.zillaid = invoices.zillaid AND zillas.divid = invoices.divid', 'LEFT');
        $this->db->join($this->config->item('table_upazilas').' upa_zilas','upa_zilas.zillaid = invoices.zillaid AND upa_zilas.upazilaid = invoices.upazilaid', 'LEFT');
        $this->db->join($this->config->item('table_unions').' unions','unions.unionid = invoices.unionid AND unions.zillaid = invoices.zillaid AND unions.upazilaid = invoices.upazilaid', 'LEFT');
        $this->db->join($this->config->item('table_uisc_infos').' uisc_infos','uisc_infos.id = invoices.uisc_id', 'INNER');
    ...
    public function get_country_wise_municipal_monthly_income_info($start_date, $end_date,$division,$zilla,$municipal,$municipal_ward)
    {
        if (!empty($division))
        {
            $this->db->where('divisions.divid',$division);
        ...
        //$this->db->order_by('divisions.divid, zillas.zillaid, municipals.municipalid, municipal_wards.wardid, invoices.invoice_date','ASC');
        $this->db->order_by('invoices.total_income','DESC');
        $result = $this->db->get()->result_array();
        //      echo $this->db->last_query();
        return $result;
    ...
    public function get_country_wise_city_corporation_monthly_income_info($start_date, $end_date,$division,$zilla,$city_corporation,$city_corporation_ward)
    {
        if (!empty($division))
        {
            $this->db->where('divisions.divid',$division);
        ...
        //$this->db->order_by('divisions.divid, zillas.zillaid, city_corporations.citycorporationid, city_corporation_wards.citycorporationwardid, uisc_infos.id,invoices.invoice_date','ASC');
        $this->db->order_by('invoices.total_income','DESC');
        $result = $this->db->get()->result_array();
        //echo $this->db->last_query();
        return $result;
    ...
    public function get_uisc_registration_union_user_info($division, $zilla, $upazila, $union)
    {
        ...
        $this->db->group_by('divisions.divid, zillas.zillaid, upa_zilas.upazilaid, unions.unionid, uisc_infos.id');
        $this->db->order_by('divisions.divid, zillas.zillaid, upa_zilas.upazilaid, unions.unionid','ASC');
        $result = $this->db->get()->result_array();
        //echo $this->db->last_query();
        return $result;
