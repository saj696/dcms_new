...
class Upload_report_model extends CI_Model
{
    ...
    public function get_union_report_upload_status($division, $zilla, $upazila, $union, $from_date, $to_date)
    {
        ...
        $CI->db->join($CI->config->item('table_divisions') . " divisions", 'divisions.divid = uisc_infos.division', 'LEFT');
        $CI->db->join($CI->config->item('table_zillas') . " zillas", 'zillas.divid = uisc_infos.division AND zillas.zillaid = uisc_infos.zilla', 'LEFT');
        $CI->db->join($CI->config->item('table_upazilas') . " upa_zilas", 'upa_zilas.zillaid = uisc_infos.zilla AND upa_zilas.upazilaid = uisc_infos.upazilla', 'LEFT');
        $CI->db->join($CI->config->item('table_unions') . " unions", 'unions.zillaid = uisc_infos.zilla AND unions.upazilaid = uisc_infos.upazilla AND unions.unionid = uisc_infos.union', 'LEFT');
        ...
        $CI->db->order_by('uisc_infos.division, uisc_infos.zilla, uisc_infos.upazilla,uisc_infos.union, invoices.invoice_date', 'ASC');
