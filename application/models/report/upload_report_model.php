...
class Upload_report_model extends CI_Model
{
    ...
    public function get_municipal_report_upload_status($division, $zilla, $municipal, $municipal_ward, $from_date, $to_date)
    {
        $CI = & get_instance();
    ...
    public function get_city_corporation_report_upload_status($division, $zilla, $city_corporation, $city_corporation_ward, $from_date, $to_date)
    {
