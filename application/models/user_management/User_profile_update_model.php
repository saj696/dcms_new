...
class User_profile_update_model extends CI_Model
{
    ...
    public function get_users_info()
    {
        ...
        {
            $this->db->where('user.user_group_id', $this->config->item('UISC_GROUP_ID'));
        ...
        {
            $user['edit_link']=$CI->get_encoded_url('user_management/user_profile_update/index/edit/'.$user['id']);
            if($user['status']==1)
            {
