...
<div class="" >
<form action="<?php echo $CI->get_encoded_url('approval/entrepreneur_approval/index/save'); ?>" class="signup" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    <div class="box round first">
            <div class="box round first">
                ...
                <div class="block">
                    <table width="50%" class="signup table">
                        <tbody>
                            <tr>
                                <input type="hidden" id="uisc_id" name="uisc_id" value="<?php echo $uisc_detail['id'];?>" />
                                <input type="hidden" id="uisc_type" name="uisc_type" value="<?php echo $uisc_detail['uisc_type'];?>" />
                                ...
                                <input type="hidden" id="upazilla" name="upazilla" value="<?php echo $uisc_detail['upazilla'];?>" />
                                <input type="hidden" id="union" name="union" value="<?php echo $uisc_detail['union'];?>" />
                                ...
                                <input type="hidden" id="union_name" name="union_name" value="<?php echo $uisc_detail['unionname'];?>" />
                                <input type="hidden" id="city_corporation_name" name="city_corporation_name" value="<?php echo $uisc_detail['citycorporationname'];?>" />
                                <input type="hidden" id="city_corporation_ward_name" name="city_corporation_ward_name" value="<?php echo $uisc_detail['city_corporation_word_name'];?>" />
                                <input type="hidden" id="municipal_name" name="municipal_name" value="<?php echo $uisc_detail['municipalname'];?>" />
                                <input type="hidden" id="municipal_ward_name" name="municipal_ward_name" value="<?php echo $uisc_detail['municipal_word_name'];?>" />

                                <input type="hidden" id="gender" name="gender" value="<?php echo $uisc_detail['entrepreneur_sex'];?>" />
                                ...
                                <input type="hidden" id="user_image" name="user_image" value="<?php echo $uisc_detail['image'];?>" />

                                <td class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('TYPE');?></span></td>
                                ...
                                <?php
                                if($uisc_detail['uisc_type']==$this->config->item('ONLINE_UNION_GROUP_ID'))
                                {
                                    $uisc_type = $this->lang->line('UNION_PARISHAD');
                                    ?>
                                ...
                                else if($uisc_detail['uisc_type']==$this->config->item('ONLINE_CITY_CORPORATION_WORD_GROUP_ID'))
                                {
                                    $uisc_type = $this->lang->line('CITY_CORPORATION');
                                    ?>
                                    <td class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('CITY_CORPORATION');?></span></td>
                                <?php
                                }
                                else if($uisc_detail['uisc_type']==$this->config->item('ONLINE_MUNICIPAL_WORD_GROUP_ID'))
                                {
                                    $uisc_type = $this->lang->line('MUNICIPALITY');
                                    ?>
                    ...
                    <div class="box round first">
                            ...
                            <table width="100%" class="signup table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('FATHERS_NAME');?></span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $uisc_detail['entrepreneur_mother_name'];?></td>
                            ...
                            <table width="100%" class="signup table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            if($uisc_detail['entrepreneur_sex']==$this->config->item('GENDER_MALE'))
                                            {
                                                echo $this->lang->line('MALE');
                                            }
                                            elseif($uisc_detail['entrepreneur_sex']==$this->config->item('GENDER_MALE'))
                                            {
                                        ...
                                        <td class="text-center">
                                            ...
                                            $student_profile_picture=FCPATH.$dir['entrepreneur'].'/'.$uisc_detail['image'];
                                            if(file_exists($student_profile_picture) && !empty($uisc_detail['image']))
                                            {
                                                ?>
                                                <img style="width: 150px; height: 150px;" src="<?php echo base_url().$dir['entrepreneur'].'/'.$uisc_detail['image'];?>" height="50">
                                            <?php
                                            }
                                            else
                                            {
                        ...
                        <div class="box round first">
                            ...
                            <div class="box round first">
                                ...
                                <div id="uiscbtn">
                                    <?php
                                    //echo $this->config->item('STATUS_ACTIVE');
                                    ...
                                    elseif($uisc_detail['status']==$this->config->item('STATUS_REJECT'))
                                    {
                                        ...
                                        <label class="label label-warning" style="font-size: 15px; text-align: center">
                                            <?php echo $this->lang->line('NOT_APPROVED');?>
                                        </label>
                                        <?php
                                    }
