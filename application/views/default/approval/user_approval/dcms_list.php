...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var url = "<?php echo $CI->get_encoded_url('approval/user_approval/get_uiscs');?>";
        // prepare the data
        var source =
        {
            dataType: "json",
            dataFields: [
                ...
                { name: 'entrepreneur_address', type: 'string' },
        ...
        $("#system_dataTable").jqxGrid(
            {
                ...
                autoheight: true,
                columns: [
                    { text: '<?php echo $CI->lang->line('USER_NAME'); ?>', dataField: 'name_bn',width:'40%'},
                    { text: '<?php echo $CI->lang->line('EMAIL'); ?>', dataField: 'email',width:'20%'},
                    { text: '<?php echo $CI->lang->line('MOBILE_NO'); ?>', dataField: 'mobile',width:'10%'},
                    { text: '<?php echo $CI->lang->line('ADDRESS'); ?>', dataField: 'entrepreneur_address',width:'17%'},
