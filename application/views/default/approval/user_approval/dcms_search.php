...
<div id="system_content" class="dashboard-wrapper">
    <div class="grid_10" >
        <form action="<?php echo $CI->get_encoded_url('approval/user_approval/index/list'); ?>" class="signup" method="post" accept-charset="utf-8" id="frm_user_approval" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    function reset_all_element(division, zilla, upazila, union, city_corporation, city_corporation_word, municipal, municipal_word, list_blank_status)
    {
        if(division==1)
        {
    ...
    $(document).ready(function ()
    {
        ...
        $(document).on("click","#approve",function()
        {
            ...
            $.ajax({
                ...
                data:{
                    ...
                    id: $("#id").val(),
                    approval_status:1,
                    entrepreneur_type: $("#uisc_type").val(),
        ...
        $(document).on("change",".entrepreneur_type",function()
        {
            if($(this).val()==<?php echo $this->config->item('ONLINE_CITY_CORPORATION_WORD_GROUP_ID');?>)
            {
                ...
                reset_all_element(1,1,1,1,1,1,1,1,1)
            }
