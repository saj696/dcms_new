...
<script type="text/javascript">
    ...
    {
        turn_off_triggers();
        var url = "<?php echo $CI->get_encoded_url('basic_setup/zilla_create/get_list');?>";
        ...
        $("#system_dataTable").jqxGrid(
            {
                ...
                columns: [
                    { text: '<?php echo $CI->lang->line('ZILLA_NAME_BN'); ?>', dataField: 'zillaname', width:'50%'},
                    { text: '<?php echo $CI->lang->line('DIVISION_NAME_BN'); ?>', dataField: 'divname',filtertype: 'checkedlist', width:'40%'},
