...
<div id="system_content" class="system_content col-sm-12 text-center" style="margin-top: 5px;">
    ...
    <div class="system_content col-sm-2 text-center" >
        <div class="shadow curved-2">
            ...
            <br/>
            <h4>৫২৭৫<?php //echo sprintf($CI->lang->line('TOTAL_DIGITAL_CENTER'),Dashboard_helper::get_center_count_all()); ?></h4>
        </div>
    </div>
    ...
    <div class="system_content col-sm-2 text-center" >
        <div class="shadow curved-2">
            ...
            <br/>
            <h4><?php echo Dashboard_helper::get_total_services_all()." ".$CI->lang->line('TOTAL_SERVICES'); ?></h4>
        </div>
    </div>
