...
$entrepreneur = Dashboard_helper::get_entrepreneur_info($user->uisc_id, $user->id);
?>
...
if(!$profile_status)
{
    ...
    <div class="col-sm-12 text-center alert" >
        <h3>
            <?php echo $this->lang->line('PROFILE_STATUS_UPDATE_MASSAGE');?>
            <a href="<?php echo base_url();?>user_management/User_profile_update" style="color: red;">
                <?php echo $this->lang->line('CLICK_HERE');?>
            </a>
        </h3>
    </div>
    <br />
...
<div class="col-sm-3 text-center" style="margin-top: 5px;">
    ...
    {
        ?>
        <img src="<?php echo base_url().'images/profile.png'?>" class="profile-img">
    <?php
    }
    ?>

  <div class="profile-text">
      <h1 class="profile-name"><?php echo $this->lang->line('NAME');?> : <?php echo $entrepreneur['entrepreneur_name']; ?></h1>
      <h4 class="profile-title"><?php echo $this->lang->line('PHONE');?> : <?php echo $entrepreneur['entrepreneur_mobile']; ?></h4>
      <h4 class="profile-title"><?php echo $this->lang->line('EMAIL');?> : <?php echo $entrepreneur['entrepreneur_email']; ?></h4>
      <h4 class="profile-title"><?php echo $this->lang->line('ADDRESS');?> : <?php echo $entrepreneur['entrepreneur_address']; ?></h4>
  </div>
</div>
...
<script>
    $(function () {
        $('#container').highcharts({
            ...
            title: {
                text: '<?php echo $CI->lang->line('REPORT_TITLE_UISC').' ('.System_helper::Get_Eng_to_Bng($week_start_date).' '.$CI->lang->line('TO').' '.System_helper::Get_Eng_to_Bng($yesterday).')';?>'
            },
            xAxis: {
                categories: [<?php
             $index=0;
