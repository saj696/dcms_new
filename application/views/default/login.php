...
<div class='login_form aniamted bounceIn'>
    ...
    <div class='login'>
        ...
        <form action="<?php echo $CI->get_encoded_url("home/login");?>" method="post">
            <input type="text"  placeholder="<?php echo $this->lang->line('USER_ID');?>" name="username" required autofocus>
...
<!--        <a href="--><?php //echo base_url();?><!--home/forget_password" class="">-->
<!--            <div class='alert ' style="text-align: center; cursor: pointer;">-->
<!--                <i class='fa fa-key'></i> --><?php //echo $this->lang->line('FORGET_PASSWORD_TITLE');?>
<!--            </div>-->
<!--        </a>-->
</div>
