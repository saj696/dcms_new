    ...
    <div class="panel with-nav-tabs ">
        <div class="panel-heading" style="padding-bottom: 0px !important;">
            <ul class="nav nav-tabs" style="margin-bottom: 0px !important;">
                <li class="active"><a class="external" href="#print_media" data-toggle="tab" style="color: #000"><h3><?php echo $this->lang->line('MEDIA_PRINT_CORNER');?></h3></a></li>
            </ul>
        </div>
                                ...
                                <li class="list_class">
                                    ...
                                    if(strlen($print_info['external_link'])>1)
                                    {
                                        ...
                                        <div class="row show-grid popContainer" id="show_data" style="display: none; overflow-y: auto;">
                                            ...
                                            <div id="modal_data">
                                                <iframe src="https://drive.google.com/viewer?srcid=<?php echo $print_info['external_link']?>&pid=explorer&efh=false&a=v&chrome=false&embedded=true" width="1020px" height="400px"></iframe>
                                            </div>
                                        </div>
                                    <?php
                                    }
                                    ...
                                    {
                                    ?>
                                    <a class="external" target="_blank" href="<?php echo base_url().$directory.'/'. $print_info['file_name'];?>">
