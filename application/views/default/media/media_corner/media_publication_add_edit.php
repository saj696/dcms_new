    ...
    <div class="panel with-nav-tabs ">
        <div class="panel-heading" style="padding-bottom: 0px !important;">
            <ul class="nav nav-tabs" style="margin-bottom: 0px !important;">
                <li class="active"><a class="external" href="#publication_corner" data-toggle="tab" style="color: #000"><h3><?php echo $this->lang->line('MEDIA_PUBLICATION_CORNER');?></h3></a></li>
            </ul>
        </div>
        <div class="panel-body " style="padding-top: 0px !important;">
            <div class="tab-content">
                <div class="tab-pane fade in active" id="publication_corner">
                    <div class="well col-lg-12">
                        <ul id="print_media" class="gallery-print-media">
                            ...
                            if(is_array($publications) && sizeof($publications)>0)
                            {
                                ...
                                <li class="list_class">
                                    <?php
                                    if(strlen($publication['external_link'])>1)
                                    {
                                        ?>
                                        <div class="media_title" style="cursor: pointer;"><?php echo $publication['media_title'];?></div>
                                        <div class="row show-grid popContainer" id="show_data" style="display: none; overflow-y: auto;">
                                            ...
                                            <div id="modal_data">
                                                <iframe src="https://drive.google.com/viewer?srcid=<?php echo $publication['external_link']?>&pid=explorer&efh=false&a=v&chrome=false&embedded=true" width="1020px" height="400px"></iframe>
                                            </div>
                                        </div>
                                    <?php
                                    }
                                    elseif(strlen($publication['file_name'])>1)
                                    {
                                        ?>
                                        <a class="external" target="_blank" href="<?php echo base_url().$directory.'/'. $publication['file_name'];?>">
                                            <img src="<?php echo base_url() ?>images/download-icon.png" style="width: 20px;" />
                                            <?php echo $publication['media_title'];?>
                                        </a>
                                    <?php
                                    }
                                    ?>
