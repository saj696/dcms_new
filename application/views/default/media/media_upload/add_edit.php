...
<div id="system_content" class="system_content_margin">
    ...
    <form id="system_save_form" action="<?php echo $CI->get_encoded_url('media/media_upload/index/save'); ?>" method="post" class="signup form_valid" enctype="multipart/form-data">
        ...
        <div class="row widget">
            ...
            <div style="display: <?php if($MediaInfo['media_type']==2){echo 'show';}else{echo 'none';}?>;" class="row show-grid link">
                <div class="col-xs-4">
            ...
            <div style="display: <?php if($MediaInfo['media_type']==3 || $MediaInfo['media_type']==4){echo 'show';}else{echo 'none';}?>;" class="row show-grid external_link">
                <div class="col-xs-4">
                    <label class="control-label pull-right"><?php echo $CI->lang->line('EXTERNAL_LINK'); ?></label>
                </div>
                <div class="col-sm-4 col-xs-8">
                    <input type="text" name="media[external_link]" class="form-control validate[required]" value="<?php echo $MediaInfo['external_link'];?>" />
                </div>
            ...
            <div class="row show-grid file_up">
                ...
                <div class="col-xs-2">
                    <input type="file" name="file_name" data-preview-container="#resume_container" data-preview-height="50" class="validate[required]" value="" />
                </div>
                <div class="col-xs-2" id="resume_container">
                    ...
                    if($MediaInfo['file_name'])
                    {
                        ...
                        {
                            ?>
                            <img src="<?php echo base_url().$directory.'/'.$MediaInfo['file_name'];?>" height="150" width="150">
                        <?php
                        }
                        else
                        {
