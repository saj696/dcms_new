...
<div id="system_content" class="system_content_margin">
    ...
    <div class="col-lg-8">
        ...
        <form class="report_form" id="system_save_form" action="<?php echo $CI->get_encoded_url('report/activities_city_corporation_user_login_status_report/index/list'); ?>" method="get">
