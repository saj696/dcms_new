...
//                                        $grand_total_invoice_amount += $total_income;
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo System_helper::Get_Eng_to_Bng($total_men+$total_women+$total_tribe+$total_disability);?></td>
                                        </tr>
                                        <?php
                                    }
                                }
                ...
                <tr style="background: #EEEEEE">
                    ...
                    <th><?php echo System_helper::Get_Eng_to_Bng($grand_total_invoice_men+$grand_total_invoice_women+$grand_total_invoice_tribe+$grand_total_invoice_disability);?></th>
                </tr>
            <?php
            }
            ?>
