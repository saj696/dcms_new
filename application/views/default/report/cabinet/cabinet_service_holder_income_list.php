...
<div id="system_content" class="system_content_margin">
    ...
    <div class="col-lg-8">
        ...
        <form class="report_form" id="system_save_form" action="<?php echo $CI->get_encoded_url('report/cabinet/cabinet_service_holder_income_report_view/index/list'); ?>" method="get">
                ...
                <div class="row show-grid ">
                    ...
                    <div class="col-sm-4 col-xs-8">
                        <select name="status" id="status" class="form-control">
                            ...
                            $report_type=array
                            (
                                array("value"=>'ALL', "text"=>$this->lang->line('ALL')),
                                array("value"=>$this->lang->line('MALE_VAL'), "text"=>$this->lang->line('MALE')),
                                array("value"=>$this->lang->line('FEMALE_VAL'), "text"=>$this->lang->line('FEMALE')),
                                array("value"=>$this->lang->line('DISABILITY_VAL'), "text"=>$this->lang->line('DISABILITY')),
                                array("value"=>$this->lang->line('TRIBE_VAL'), "text"=>$this->lang->line('TRIBE')),
                            );
                            $CI->load_view('dropdown',array('drop_down_options'=>$report_type));
                            ?>
                        </select>
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $(document).on("change","#report_type",function()
        {
            ...
            {
                report_go_url="<?php echo $CI->get_encoded_url('report/cabinet/cabinet_union_service_holder_income_list/index'); ?>";
            }
            else if(report_type_id=="<?php echo $this->config->item('ONLINE_CITY_CORPORATION_WORD_GROUP_ID');?>")
            {
                report_go_url="<?php echo $CI->get_encoded_url('report/cabinet/cabinet_city_corporation_service_holder_income_list/index'); ?>";
            }
            else if(report_type_id=="<?php echo $this->config->item('ONLINE_MUNICIPAL_WORD_GROUP_ID');?>")
            {
                report_go_url="<?php echo $CI->get_encoded_url('report/cabinet/cabinet_municipal_service_holder_income_list/index'); ?>";
            }
            else
            {
                report_go_url='';
