        ...
        <div class="col-lg-12">
            ...
            <table class="table table-responsive table-bordered">
                ...
                <tr>
                    ...
                    <th><?php echo $this->lang->line('TOTAL_UDC_UPLOAD_REPORT_PERCENTAGE'); ?></th>
                ...
                if (empty($report)) {
                    ...
                    foreach ($report as $division) {
                        foreach ($division['zilla'] as $zilla) {
                            ...
                            if (!empty($total_udc) && !empty($total_report_upload)) {
                                $total_report_upload_percentage = ($total_report_upload / $udc[$zilla['zilla_id']]);
                            } else {
                                $total_report_upload_percentage = 0;
                            }

                            if (!empty($total_udc) && !empty($total_income)) {
                                $total_income_percentage = ($total_income / $udc[$zilla['zilla_id']]);
                            } else {
                                $total_income_percentage = 0;
                            }

                            if (!empty($total_udc) && !empty($total_service_holder)) {
                                $total_service_holder_percentage = ($total_service_holder / $udc[$zilla['zilla_id']]);
                            } else {
                                $total_service_holder_percentage = 0;
                            }
                    ...
                    <tr style="background: #EEEEEE">
                        ...
                        <th><?php echo System_helper::Get_Eng_to_Bng(number_format(array_sum($udc))); ?></th>
