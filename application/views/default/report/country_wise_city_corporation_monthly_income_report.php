                ...
                <div class="col-lg-12">
                    ...
                    <table class="table table-responsive table-bordered">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line('INCOME_AMOUNT');?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                        ...
                        else
                        {
                            ...
                            for ($i = 0; $i < sizeof($report_lists); $i++)
                            {
                                ...
                                //
                                //
                                //                                    if($report_lists[$i]['citycorporationid']!=$report_lists[$i-1]['citycorporationid'])
                                //                                    {
                                //                                        $show_upzilla=true;
                                //
                                //                                        ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php if($show_upzilla){echo $report_lists[$i]['citycorporationname']; $show_upzilla=false;}?></td>
                                    <td><?php echo (isset($report_lists[$i-1]) && $report_lists[$i]['citycorporationwardid'] == $report_lists[$i-1]['citycorporationwardid']) ? '' : $report_lists[$i]['wardname']; ?></td>
