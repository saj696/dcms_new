...
<div id="system_content" class="system_content_margin">
    ...
    <div class="col-lg-8">
        ...
        <form class="report_form" id="system_save_form" action="<?php echo $CI->get_encoded_url('report/country_wise_union_monthly_income_report/index/list'); ?>" method="get">
            <div class="row widget">
                ...
                <!--   END div Dropdown list -->

                <div class="row show-grid ">
                    <div class="col-xs-4">
                        <label class="control-label pull-right"><?php echo $CI->lang->line('FROM_DATE'); ?></label>
                    </div>
                    <div class="col-sm-4 col-xs-8">
                ...
                <div class="row show-grid ">
                    <div class="col-xs-4">
                        <label class="control-label pull-right"><?php echo $CI->lang->line('TO_DATE'); ?></label>
                    </div>
                    <div class="col-sm-4 col-xs-8">
