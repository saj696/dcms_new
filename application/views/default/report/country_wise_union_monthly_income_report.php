                ...
                <div class="col-lg-12">
                    ...
                    <table class="table table-responsive table-bordered">
                        ...
                        <tr>
                            ...
                            <th class="text-center"><?php echo $this->lang->line('INCOME_AMOUNT');?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                        ...
                        else
                        {
                            ...
                            for ($i = 0; $i < sizeof($report_lists); $i++)
                            {
                                ...
                                //
                                //
                                //                                    if($report_lists[$i]['upazilaid']!=$report_lists[$i-1]['upazilaid'])
                                //                                    {
                                //                                        $show_upzilla=true;
                                //
                                //                                        ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php if($show_upzilla){echo $report_lists[$i]['upazilaname']; $show_upzilla=false;}?></td>
                                    <td><?php echo (isset($report_lists[$i-1]) && $report_lists[$i]['unionid'] == $report_lists[$i-1]['unionid']) ? '' : $report_lists[$i]['unionname']; ?></td>
                                    <td><?php echo $report_lists[$i]['uisc_name'];?></td>
                                    <td>
                                        <?php
                            ...
                            <tr>
                                <!--                                <td colspan="1"> &nbsp;</td>-->
                                <td colspan="6" align="right"><?php echo $this->lang->line('IN_TOTAL');?>: </td>
