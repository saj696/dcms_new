        ...
        <div class="col-lg-12">
            <div class="col-lg-12 text-center">
                ...
                <h5>
                    ...
                    {
                        echo $this->lang->line('NUMBER_OF_SERVICE_HOLDER');
                    }
                    else if($report_status==3)
                    {
                        echo $this->lang->line('MONTHLY_INCOME');
                    }
                    else if($report_status==4)
                    {
                        echo $this->lang->line('NUMBER_OF_SERVICE');
                    }
                    else
                    {
                ...
                foreach($report as $division)
                {
                    foreach($division['zilla'] as $zilla)
                    {
                        ...
                        foreach($zilla['city_corporation'] as $city_corporation)
                        {
                            ...
                            ?>
                            <tr>
                                <th colspan="5" style="text-align: right"><?php echo $this->lang->line('CITY_CORPORATION');?> <?php echo $this->lang->line('TOTAL');?></th>
                                <?php
                                if($report_status==1)
                                {
                                    ?>
