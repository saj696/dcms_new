...
<div id="system_content" class="system_content_margin">
    ...
    <div class="col-lg-8">
        ...
        <form class="report_form" id="system_save_form" action="<?php echo $CI->get_encoded_url('report/entrepreneur_info/education_info_report_view/index/list'); ?>" method="get">
