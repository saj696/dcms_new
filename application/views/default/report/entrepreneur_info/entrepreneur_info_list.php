...
<div id="system_content" class="system_content_margin">
    ...
    <div class="col-lg-8">
        ...
        <form class="report_form" id="system_save_form" action="<?php echo $CI->get_encoded_url('report/entrepreneur_info/entrepreneur_info_report_view/index/list'); ?>" method="get">
            <div class="row widget">
                ...
                //                                array("value"=>"2", "text"=>$this->lang->line('NUMBER_OF_SERVICE_HOLDER')),
                //                                array("value"=>"3", "text"=>$this->lang->line('MONTHLY_INCOME')),
                //                                array("value"=>"4", "text"=>$this->lang->line('NUMBER_OF_SERVICE')),
                //                            );
                //                            $CI->load_view('dropdown',array('drop_down_options'=>$report_type));
                //                            ?>
                <!--                        </select>-->
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $(document).on("change","#report_type",function()
        {
            ...
            {
                report_go_url="<?php echo $CI->get_encoded_url('report/entrepreneur_info/entrepreneur_info_union_list/index'); ?>";
            }
            else if(report_type_id=="<?php echo $this->config->item('ONLINE_CITY_CORPORATION_WORD_GROUP_ID');?>")
            {
                report_go_url="<?php echo $CI->get_encoded_url('report/entrepreneur_info/entrepreneur_info_city_corporation_list/index'); ?>";
            }
            else if(report_type_id=="<?php echo $this->config->item('ONLINE_MUNICIPAL_WORD_GROUP_ID');?>")
            {
                report_go_url="<?php echo $CI->get_encoded_url('report/entrepreneur_info/entrepreneur_info_municipal_list/index'); ?>";
            }
            else
            {
                report_go_url='';
