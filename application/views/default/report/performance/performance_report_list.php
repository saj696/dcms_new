...
<div id="system_content" class="system_content_margin">
    ...
    <div class="col-lg-8">
        ...
        <form class="report_form" id="system_save_form" action="<?php echo $CI->get_encoded_url('report/performance/performance_report_list/index/list'); ?>" method="get">
                ...
                <div class="row show-grid ">
                    ...
                    <div class="col-sm-4 col-xs-8">
                        <select name="status" id="status" class="form-control">
                            ...
                            <?php
                            foreach($this->config->item('performance_report') as $val=>$service_type)
                            {
                                ?>
