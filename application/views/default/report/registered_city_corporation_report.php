                        ...
                        else
                        {
                            ...
                            for ($i = 0; $i < sizeof($getUiscInfos); $i++)
                            {
                                ...
                                else
                                {
                                    ...
                                    if($getUiscInfos[$i]['citycorporationid']!=$getUiscInfos[$i-1]['citycorporationid'])
                                    {
                                        $show_upzilla=true;
                                        ...
                                        <tr style="background-color: #cccccc">
                                            <td colspan="2"> &nbsp;</td>
                                            <td ><?php echo $this->lang->line('CITY_CORPORATION');?> </td>
                                            <td >&nbsp;</td>
                                ...
                                else
                                {
                                    ...
                                    if(sizeof($getUiscInfos)>($i+1))
                                    {
                                        ...
                                        if(($getUiscInfos[$i]['divid']==$getUiscInfos[$i+1]['divid'])&&($getUiscInfos[$i]['zillaid']==$getUiscInfos[$i+1]['zillaid'])&&($getUiscInfos[$i]['citycorporationid']==$getUiscInfos[$i+1]['citycorporationid'])&&($getUiscInfos[$i]['citycorporationwardid']==$getUiscInfos[$i+1]['citycorporationwardid']))
                                        {
                                            $i++;
                                    ...
                                    $union_total=$getUiscInfos[$i]['total_user'];
                                ...
                                <tr>
                                    ...
                                    <td><?php if($show_upzilla){echo $getUiscInfos[$i]['citycorporationname']; $show_upzilla=false;}?></td>
