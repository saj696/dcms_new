                ...
                <div class="col-lg-12">
                    ...
                    <table class="table table-responsive table-bordered">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line('ENTREPRENEUR_MOBILE_NO');?></th>
                            <th><?php echo $this->lang->line('ENTREPRENEUR_EMAIL');?></th>
                            ...
                            foreach($getUiscInfos as $uisc)
                            {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($show_upzilla == '')
                                        {
                                            echo $uisc['citycorporationname'];
                                            $show_upzilla = $uisc['citycorporationname'];
                                            //$currentDate = $preDate;
                                        }
                                        else if ($show_upzilla == $uisc['citycorporationname'])
                                        {
                                            //exit;
                                            echo "&nbsp;";
                                        }
                                    ...
                                    <td><?php echo $uisc['entrepreneur_email'] ?></td>
