                        ...
                        else
                        {
                            ...
                            for ($i = 0; $i < sizeof($getUiscInfos); $i++)
                            {
                                ...
                                else
                                {
                                    ...
                                    if($getUiscInfos[$i]['upazilaid']!=$getUiscInfos[$i-1]['upazilaid'])
                                    {
                                        $show_upzilla=true;
                                        ...
                                        <tr style="background-color: #cccccc">
                                            <td colspan="2"> &nbsp;</td>
                                            <td ><?php echo $this->lang->line('UPAZILLA');?> </td>
                                            <td >&nbsp;</td>
                                ...
                                else
                                {
                                    ...
                                    if(sizeof($getUiscInfos)>($i+1))
                                    {
                                        ...
                                        if(($getUiscInfos[$i]['divid']==$getUiscInfos[$i+1]['divid'])&&($getUiscInfos[$i]['zillaid']==$getUiscInfos[$i+1]['zillaid'])&&($getUiscInfos[$i]['upazilaid']==$getUiscInfos[$i+1]['upazilaid'])&&($getUiscInfos[$i]['unionid']==$getUiscInfos[$i+1]['unionid']))
                                        {
                                            $i++;
                                ...
                                <tr>
                                    ...
                                    <td><?php if($show_upzilla){echo $getUiscInfos[$i]['upazilaname']; $show_upzilla=false;}?></td>
                                    <td><?php echo $getUiscInfos[$i]['unionname']?></td>
