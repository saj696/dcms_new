        ...
        <div class="col-lg-12">
            ...
            else
            {
                ...
                foreach($report as $division)
                {
                    ...
                    {
                        $municipal_total_government_service=0;
                        $municipal_total_private_service=0;
                        $municipal_total_local_service=0;
                        $municipal_total_all_service=0;
                        ...
                        //                                {
                        //                                    ?>
                        <!--                                    <th>--><?php //echo System_helper::Get_Eng_to_Bng($municipal_total_service_holder);?><!--</th>-->
                        <!--                                    <th>--><?php //echo System_helper::Get_Eng_to_Bng($municipal_total_monthly_income);?><!--</th>-->
                        <!--                                    <th>--><?php //echo System_helper::Get_Eng_to_Bng($municipal_total_service);?><!--</th>-->
                        <!--                                --><?php
                        //                                }
                        //                                else if($report_status==2)
                        //                                {
