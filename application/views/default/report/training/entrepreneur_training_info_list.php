...
<div id="system_content" class="system_content_margin">
    ...
    <div class="col-lg-8">
        ...
        <form class="report_form" id="system_save_form" action="<?php echo $CI->get_encoded_url('report/training/entrepreneur_training_info_report_view/index/list'); ?>" method="get">
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $(document).on("change","#report_type",function()
        {
            ...
            {
                report_go_url="<?php echo $CI->get_encoded_url('report/training/entrepreneur_training_info_union_list/index'); ?>";
            }
            else if(report_type_id=="<?php echo $this->config->item('ONLINE_CITY_CORPORATION_WORD_GROUP_ID');?>")
            {
                report_go_url="<?php echo $CI->get_encoded_url('report/training/entrepreneur_training_info_city_corporation_list/index'); ?>";
            }
            else if(report_type_id=="<?php echo $this->config->item('ONLINE_MUNICIPAL_WORD_GROUP_ID');?>")
            {
                report_go_url="<?php echo $CI->get_encoded_url('report/training/entrepreneur_training_info_municipal_list/index'); ?>";
            }
            else
            {
                report_go_url='';
