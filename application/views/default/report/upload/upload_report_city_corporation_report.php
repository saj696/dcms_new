        ...
        <div class="col-lg-12">
            ...
            <table class="table table-responsive table-bordered">
                ...
                <?php if (empty($zilla)) { ?>
                    <tr>
                        <th class="text-center"
                            ...
                            <br/>
                            <?= $this->lang->line('TOTAL_CITY_CORPORATION') . System_helper::Get_Eng_to_Bng(sizeof(Query_helper::get_info('city_corporations', 'rowid', array('divid =' . $uisc_data[0]['divid'])))) ?>
                            <br/>
                        </th>
                    </tr>
                <?php } ?>
                ...
                for ($i = 0; $i < sizeof($uisc_data); $i++) {
                    ?>
                    <?php if ($uisc_data[$i]['zillaname'] != $check_zilla && empty($city_corporation)) { ?>
                        ...
                        <tr>
                            <th colspan="<?= $numDays + 4 ?>" class="text-center">
                                ...
                                <?= $this->lang->line('TOTAL_CITY_CORPORATION') . System_helper::Get_Eng_to_Bng(sizeof(Query_helper::get_info('city_corporations','rowid',array('zillaid ='.$uisc_data[$i]['zillaid'])))) . ', ' . $this->lang->line('TOTAL_WARD') . System_helper::Get_Eng_to_Bng(count(Query_helper::get_info($this->config->item('table_city_corporation_wards'), 'rowid', array('zillaid =' . $uisc_data[$i]['zillaid'])))); ?>
                            </th>
                        </tr>
                        <?php $check_zilla = $uisc_data[$i]['zillaname'];
                    } ?>
                    <?php if ($uisc_data[$i]['citycorporationname'] != $check_city) { ?>
                        <tr>
                            <th colspan="<?= $numDays + 4 ?>" class="text-center">
                                <?php echo $uisc_data[$i]['citycorporationname'] ?> <br>
                                <?= $this->config->item('month')[$month] . '-' . System_helper::Get_Eng_to_Bng($year) . "<br/>" ?>
                                <?= $this->lang->line('TOTAL_WARD') . ' ' . System_helper::Get_Eng_to_Bng(count(Query_helper::get_info($this->config->item('table_city_corporation_wards'), 'rowid', array('zillaid =' . $uisc_data[$i]['zillaid'], 'citycorporationid =' . $uisc_data[$i]['citycorporationid'])))) ?>
                            </th>
                        </tr>
                        <tr>
                        ...
                        <?php
                        $check_city = $uisc_data[$i]['citycorporationname'];
                    }
                    ?>
                    <tr>
                        ...
                        ?></td>-->
                        <td><?= ($uisc_data[$i]['wardname'] != $check_ward) ? $uisc_data[$i]['wardname'] : "";
                            $check_ward = $uisc_data[$i]['wardname']; ?></td>
