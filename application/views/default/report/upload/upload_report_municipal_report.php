        ...
        <div class="col-lg-12">
            ...
            <table class="table table-responsive table-bordered">
                ...
                for ($i = 0; $i < sizeof($uisc_data); $i++) {
                    ?>
                    <?php if ($uisc_data[$i]['zillaname'] != $check_zilla && empty($municipal)) { ?>
                        ...
                        <tr>
                            <th colspan="<?= $numDays + 4 ?>" class="text-center">
                                ...
                                <?= $this->lang->line('TOTAL_MUNICIPAL') . System_helper::Get_Eng_to_Bng(sizeof(Query_helper::get_info('municipals','rowid',array('zillaid ='.$uisc_data[$i]['zillaid'])))) . ', ' . $this->lang->line('TOTAL_WARD') . System_helper::Get_Eng_to_Bng(sizeof(Query_helper::get_info('municipal_wards','rowid',array('zillaid ='.$uisc_data[$i]['zillaid'])))); ?>
                            </th>
                        </tr>
                        <?php $check_zilla = $uisc_data[$i]['zillaname'];
                    } ?>
                    <?php if ($uisc_data[$i]['municipalname'] != $check_municipal) { ?>
                        <tr>
                            <th colspan="<?= $numDays + 4 ?>" class="text-center">
                                <?php echo $uisc_data[$i]['municipalname'] .' '. $this->lang->line('MUNICIPAL_NAME') ?> <br>
                                <?= $this->config->item('month')[$month] . '-' . System_helper::Get_Eng_to_Bng($year) . "<br/>" ?>
                                <?= $this->lang->line('TOTAL_WARD') . ' ' . System_helper::Get_Eng_to_Bng(count(Query_helper::get_info($this->config->item('table_municipal_wards'), 'rowid', array('zillaid =' . $uisc_data[$i]['zillaid'], 'municipalid =' . $uisc_data[$i]['municipalid'])))) ?>
                            </th>
                        </tr>
                        <tr>
                        ...
                        <?php
                        $check_municipal = $uisc_data[$i]['municipalname'];
                    }
                    ?>
                    <tr>
