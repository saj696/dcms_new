            ...
            <div class="col-lg-12">
                ...
                <table class="table table-responsive table-bordered">
                        ...
                        foreach($report as $row)
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {
                                        echo $row['citycorporationname'];
                                        $city_corporation_name = $row['citycorporationname'];
                                        //$currentDate = $preDate;
                                    }
                                    else if ($city_corporation_name == $row['citycorporationname'])
                                    {
                                        //exit;
                                        echo "&nbsp;";
                                    }
                                ...
                                <td>
                                    ...
                                    {
                                        echo $row['wardname'];
                                        $city_corporation_ward_name = $row['wardname'];
                                        //$currentDate = $preDate;
                                    }
                                    else if ($city_corporation_ward_name == $row['wardname'])
                                    {
                                        //exit;
                                        echo "&nbsp;";
                                    }
                    ...
                    <tr>
                        ...
                        <th><?php echo System_helper::Get_Eng_to_Bng($total?$total:0);?></th>
                    </tr>
                    </tfoot>
                    <?php }?>
                </table>
