                    ...
                    foreach($report as $row)
                    {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if ($municipal_name == '')
                                {
                                    echo $row['municipalname'];
                                    $municipal_name = $row['municipalname'];
                                    //$currentDate = $preDate;
                                }
                                else if ($municipal_name == $row['municipalname'])
                                {
                                    //exit;
                                    echo "&nbsp;";
                                }
                            ...
                            <td>
                                ...
                                {
                                    echo $row['wardname'];
                                    $municipal_ward_name = $row['wardname'];
                                    //$currentDate = $preDate;
                                }
                                else if ($municipal_ward_name == $row['wardname'])
                                {
                                    //exit;
                                    echo "&nbsp;";
                                }
