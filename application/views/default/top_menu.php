        ...
        <div class="col-lg-12">
            <div class="top-nav" style="clear:both; border-bottom:1px solid #CCC;display:inline-table;">
                <ul class="nav1">
                    ...
                    <li>
                        <a class="external" href="#">রেজিস্ট্রেশন</a>
                        <ul class="subs">
                            <li><a href="<?php echo base_url() . 'website/entrepreneur_registration'; ?>">সেন্টার
                                    রেজিস্ট্রেশন</a></li>
                            <li><a href="<?php echo base_url() . 'website/user_registration'; ?>">উদ্যোক্তা
                                    রেজিস্ট্রেশন</a></li>
                        </ul>
                    </li>
                    <li><a class="external" href="#">রেজিষ্ট্রেশন নির্দেশনা</a>
                        <ul class="subs">
                            <li><a class="external"
                                   href="<?php echo base_url() . 'website/registration_direction/center'; ?>">সেন্টার
                                    রেজিস্ট্রেশন নির্দেশনা</a></li>
                            <li><a class="external"
                                   href="<?php echo base_url() . 'website/registration_direction/entrepreneur'; ?>">উদ্যোক্তা
                                    রেজিস্ট্রেশন নির্দেশনা</a></li>
                            <li><a class="external"
                                   href="<?php echo base_url() . 'website/registration_direction/profile_update'; ?>">প্রোফাইল
                                    আপডেটের ম্যানুয়াল</a></li>
                            <li><a class="external"
                                   href="<?php echo base_url() . 'website/registration_direction/approval'; ?>">রেজিষ্ট্রেশন
                                    অনুমোদনের পদ্ধতি</a></li>
                            <li><a class="external" href="<?php echo base_url() . 'website/registration_form'; ?>">রেজিস্ট্রেশন
                                    ফরম</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="external" href="#"> হেল্প ডেস্ক</a>
                        <ul class="subs">
                            <li><a class="external" href="<?php echo base_url() . 'website/user_direction'; ?>">ব্যবহারকারী
                                    নির্দেশনা</a></li>
                            <li><a href="<?php echo base_url() . 'website/help_desk_contact'; ?>">হেল্প ডেস্কে
                                    যোগাযোগ</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#">মিডিয়া কর্ণার</a>
                        <ul class="subs">
                            <li><a href="<?php echo base_url(); ?>media/media_corner_photo/">ছবি কর্ণার</a></li>
                            <li><a href="<?php echo base_url(); ?>media/media_corner_video/">ভিডিও কর্ণার</a></li>
                            <li><a href="<?php echo base_url(); ?>media/media_corner_print/">প্রিন্ট মিডিয়া কর্ণার</a>
                            </li>
                            <li><a href="<?php echo base_url(); ?>media/media_corner_publication/">পাবলিকেশন্স
                                    কর্ণার</a></li>
                        </ul>
                    </li>
