...
if($user)
{
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="top-nav" style="clear:both; border-bottom:1px solid gray;display:inline-table;width:100%;text-align: center;">
                <ul class="nav1">
            ...
            <div class="top-nav" style="clear:both; border-bottom:1px solid #CCC;display:inline-table;">
                <ul class="nav1">
                    ...
                    <li>
                        ...
                        <ul class="subs">
                            <li><a href="<?php echo base_url().'website/entrepreneur_registration';?>">সেন্টার রেজিস্ট্রেশন</a></li>
                            <li><a href="<?php echo base_url().'website/user_registration';?>">উদ্যোক্তা রেজিস্ট্রেশন</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="subs">
                            ...
                            <li><a href="<?php echo base_url();?>media/media_corner_print/">প্রিন্ট মিডিয়া কর্ণার</a></li>
                            <li><a href="<?php echo base_url();?>media/media_corner_publication/">পাবলিকেশন্স কর্ণার</a></li>
                        </ul>
                    </li>
