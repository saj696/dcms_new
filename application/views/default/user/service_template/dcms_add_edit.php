        ...
        <div class="col-lg-12">
            ...
            <div class="text-center ">
                <h4 class="text-danger">
                    প্রিয় উদ্যোক্তা বন্ধু, ডিজিটাল সেন্টার ম্যানেজমেন্ট সিস্টেমের ডাটা মাইগ্রেশনের কাজ চলমান

                    রয়েছে। আপনাদের সকলকে সিস্টেম থেকে রিপোর্ট আপলোড টেমপ্লেট ডাউনলোড করে/সিস্টেম

                    থেকে বিগত সকল মাসের/তারিখের সকল রিপোর্ট আপলোড করার অনুরোধ জানাচ্ছি। এক্সেল

                    টেমপ্লেটে ডাউনলোড/সিস্টেম থেকে রিপোর্ট আপলোড করার পূর্বে ই-সেবা মেন্যুর ই-সেবা

                    সংযুক্তি অপশন থেকে সেন্টার থেকে প্রদত্ত সেবাগুলো নির্বাচন করে সংরক্ষণ করতে হবে।

                    এরপর এক্সেল টেমপ্লেটে/ সিস্টেম থেকে প্রতিবেদন আপলোড করুন। এক্সেল টেমপ্লেটে

                    প্রতিবেদন আপলোডের সময় পুরুষ/মহিলা এবং সেবার নাম ড্রপডাউন মেন্যু থেকে সিলেক্ট করে

                    দিতে হবে। আপনাদের আন্তরিক সহযোগিতার জন্য ধন্যবাদ।
                </h4>
            </div>
        </div>
        <div class="clearfix"></div>
                                ...
                                <th class="fieldcell">
                                    <div class="input select">
                                        <select name="customer_gender[]" id="customer_gender" class="selectbox-1 validate[required]">
                                            ...
                                            <option value="<?php echo $this->lang->line('DISABILITY')?>"><?php echo $this->lang->line('DISABILITY');?></option>
                                            <option value="<?php echo $this->lang->line('TRIBE')?>"><?php echo $this->lang->line('TRIBE');?></option>
                                        </select>
                                    </div>
                                </th>
...
<script type="text/javascript">
    ...
    function RowIncrement()
    {
        ...
        <option value=''><?php echo $this->lang->line('SELECT');?></option><option value='<?php echo $this->lang->line('MALE_VAL')?>'><?php echo $this->lang->line('MALE');?></option><option value='<?php echo $this->lang->line('FEMALE_VAL');?>'><?php echo $this->lang->line('FEMALE');?></option>\n\
            <option value='<?php echo $this->lang->line('DISABILITY_VAL');?>'><?php echo $this->lang->line('DISABILITY');?></option><option value='<?php echo $this->lang->line('TRIBE_VAL');?>'><?php echo $this->lang->line('TRIBE');?></option></select>";
