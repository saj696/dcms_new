...
if($userInfo['id']>0 && ($userInfo['user_group_id'] == $this->config->item('SUPER_ADMIN_GROUP_ID') || $userInfo['user_group_level']== $this->config->item('A_TO_I_GROUP_ID') || $userInfo['user_group_level']== $this->config->item('DONOR_GROUP_ID') || $userInfo['user_group_level']== $this->config->item('MINISTRY_GROUP_ID')))
{
...
else if($userInfo['id']>0 && ($userInfo['user_group_level'] == $this->config->item('DIVISION_GROUP_ID')))
{
...
else if($userInfo['id']>0 && ($userInfo['user_group_level'] == $this->config->item('DISTRICT_GROUP_ID')))
{
    $display_division='block';
    $display_zilla='block';
    $display_upazila='none';
...
else if($userInfo['id']>0 && ($userInfo['user_group_level'] == $this->config->item('UPAZILLA_GROUP_ID')))
{
    $display_division='block';
    $display_zilla='block';
...
else if($userInfo['id']>0 && ($userInfo['user_group_level'] == $this->config->item('UNION_GROUP_ID')))
{
    $display_division='block';
    $display_zilla='block';
    $display_upazila='block';
...
else if($userInfo['id']>0 && ($userInfo['user_group_level'] == $this->config->item('CITY_CORPORATION_GROUP_ID')))
{
    $display_division='block';
    $display_zilla='block';
    $display_upazila='none';
...
else if($userInfo['id']>0 && ($userInfo['user_group_level'] == $this->config->item('CITY_CORPORATION_WORD_GROUP_ID')))
{
    $display_division='block';
    $display_zilla='block';
    $display_upazila='none';
...
else if($userInfo['id']>0 && ($userInfo['user_group_level'] == $this->config->item('MUNICIPAL_GROUP_ID')))
{
    $display_division='block';
    $display_zilla='block';
    $display_upazila='none';
...
else if($userInfo['id']>0 && ($userInfo['user_group_level'] == $this->config->item('MUNICIPAL_WORD_GROUP_ID')))
{
    $display_division='block';
    $display_zilla='block';
    $display_upazila='none';
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $(document).on("change","#user_group_id",function()
        {
            ...
            var group_id_level=$(this).val().split('-');

            var group_level=0;

            $("#user_division_id").val("");

            if(group_id_level.length==2)
            {
                group_level=group_id_level[1];
            }
            else
            {
                group_level=0;
            ...
            if(group_level==SUPER_ADMIN_GROUP_ID || group_level==A_TO_I_GROUP_ID || group_level==DONOR_GROUP_ID || group_level==MINISTRY_GROUP_ID)
            {
                elm_hide();
            }
            else if(group_level==DIVISION_GROUP_ID)
            {
                elm_hide(1);
            }
            else if(group_level==DISTRICT_GROUP_ID)
            {
                elm_hide(1);
            ...
            else if(group_level==UPAZILLA_GROUP_ID)
            {
                elm_hide(1);
                // START DISTRICT INFOS
                $(document).on("change","#user_division_id",function()
            ...
            else if(group_level==UNION_GROUP_ID)
            {
                elm_hide(1);
                // START DISTRICT INFOS
                $(document).on("change","#user_division_id",function()
            ...
            else if(group_level==CITY_CORPORATION_GROUP_ID)
            {
                elm_hide(1);
                // START DISTRICT INFOS
                $(document).on("change","#user_division_id",function()
            ...
            else if(group_level==CITY_CORPORATION_WORD_GROUP_ID)
            {
                elm_hide(1);
                // START DISTRICT INFOS
                $(document).on("change","#user_division_id",function()
            ...
            else if(group_level==MUNICIPAL_GROUP_ID)
            {
                elm_hide(1);
                // START DISTRICT INFOS
                $(document).on("change","#user_division_id",function()
            ...
            else if(group_level==MUNICIPAL_WORD_GROUP_ID)
            {
                elm_hide(1);
                // START DISTRICT INFOS
                $(document).on("change","#user_division_id",function()
