                ...
                <table class="signup table">
                    <tbody>
                        <tr>
                            ...
                            <td class="fieldcell">
                                <label class="labelcell">
                                    <?php echo $password_detail['username'];?>
                                    <input type="hidden" id="email" name="email" value="<?php echo $password_detail['email'];?>" />
                                </label>
                            </td>
