...
<!-- START DIGITAL_CENTER_RELATED_INFO-->
        ...
        <table class="signup table" width="100%">
            ...
            <tr>
                ...
                <td class="custom smalllabelcell">
                    <span class="labelcell"><?php echo $this->lang->line('EMAIL');?></span>
                </td>
                <td class="custom fieldcell">
            ...
            <tr>
                <td class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('MOBILE_NO');?> </td>
                <td class="custom labelcell">
                    <span class="fieldcell">
                        <input type="text"  class="" value="" maxlength="11" id="uisc_mobile_no" name="uisc_mobile_no" />
                    </span>
                </td>
...
<!-- END DIGITAL_CENTER_RELATED_INFO-->
<!-- START CHAIRMEN_RELATED_INFO-->
<div class="box round first">
    <h2><?php echo $this->lang->line('CHAIRMEN_RELATED_INFO');?></h2>
    <div class="block ">
        <table class="signup table" width="100%">
            <tbody>
            <tr>
                ...
                <td width="28%" class="custom fieldcell">
                    <div class="input text">
                        <input name="chairmen_name" id="chairmen_name" class="validate[required]" type="text"/>
                    </div>
                </td>
                ...
                <td width="29%" class="custom fieldcell">
                    <div class="input text">
                        <input name="chairmen_mobile" id="chairmen_mobile" class="validate[required]" type="text" maxlength="11" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td width="29%" class="custom fieldcell">
                    <div class="input text">
                        <input name="chairmen_email" id="chairmen_email" class="validate[required,custom[email]]" type="text"/>
                    </div>
                </td>
                ...
                <td width="29%" class="custom fieldcell">
                    <div class="input textarea">
                        <textarea name="chairmen_address" id="chairmen_address" rows="1" cols="22" class="validate[required]"></textarea>
                    </div>
                </td>
            </tr>
            </tbody>
        ...
        <table class="signup table" width="100%">
            <tbody>
                ...
                <tr>
                    ...
                    <td  class="custom fieldcell">
                        <div class="input select">
                            <select name="ques_id" id="ques_id" class="selectbox-1">
                                <?php
                    ...
                    <td  class="custom fieldcell">
                        <div class="input text">
                            <input name="ques_ans" id="ques_ans" class="" type="text"/>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td class="custom smalllabelcell"><span class="labelcell">
                        <?php echo $this->lang->line('ATTACHMENT');?><span style="color: #FF0000">*</span>
                    </td>
                    <td  class="custom fieldcell">
                        <div class="input select">
