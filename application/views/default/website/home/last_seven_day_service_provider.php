...
<div class="main_container">
    ...
    <div class="col-lg-12">
        <div class="col-lg-12 text-center">
            ...
            <h5><?php echo sprintf($this->lang->line('LAST_SEVEN_DAYS_TOP_SERVICE_PROVIDER_TITLE'),System_helper::Get_Eng_to_Bng($srt_date6)." -- ".System_helper::Get_Eng_to_Bng($srt_date_0));?></h5>
        </div>
        <table class="table table-responsive table-bordered">
            ...
            <tr>
                ...
                <th><?php echo $this->lang->line('ZILLA');?>/<?php echo $this->lang->line('CITY_CORPORATION');?></th>
                <th><?php echo $this->lang->line('UPAZILLA');?>/<?php echo $this->lang->line('MUNICIPALITY');?></th>
            ...
            else
            {
                ...
                foreach ($report_records as $report_record)
                {
                    ...
                    <tr>
                        ...
                        <td align='center'><?php echo $report_record['divname'] ?></td>
                        <td align='center'>
                            <?php
                            if(!empty($report_record['citycorporationname']))
                            {
                        ...
                        <td align='center'>
                            <?php
                            if(!empty($report_record['municipalname']))
                            {
