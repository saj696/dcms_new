...
<div class="grid_10" >
<form action="<?php echo $CI->get_encoded_url('website/user_registration/index/save'); ?>" class="signup" method="post" accept-charset="utf-8" enctype="multipart/form-data">
...
<div class="box round first">
    ...
    <div class="block ">
        <table class="signup table" width="100%">
            <tbody>
            <tr>
                <td class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('TYPE');?></span> <span style="color: #FF0000">*</span></td>
            ...
            <tr>
                <td class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('DIVISION');?></span><span style="color: #FF0000">*</span></td>
            ...
            <tr>
                <td class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('DIGITAL_CENTER_NAME');?></span><span style="color: #FF0000">*</span></td>
                <td class="custom fieldcell" >
                    <select name="uisc_name" id="uisc_name" class="selectbox-1 union validate[required]">
                        <option value=""><?php echo $this->lang->line('SELECT');?></option>
                    </select>
                </td>
            ...
            <tr>
                <td class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('MOBILE_NO');?></span><span style="color: #FF0000">*</span></td>
                <td class="custom labelcell">
                    <span class="fieldcell">
                        <input type="text"  class="required validate[required]" value="" maxlength="11" id="uisc_mobile_no" name="uisc_mobile_no" />
                    </span>
                </td>
...
<!--     START SECRETARY_RELATED_INFO -->
    ...
    <!--            <tbody>-->
    <!--            <tr>-->
    <!--                <td class="custom smalllabelcell"><span class="labelcell">--><?php //echo $this->lang->line('NAME');?><!--</span><span style="color: #FF0000">*</span></td>-->
    ...
    <!--                    <div class="input text">-->
    <!--                        <input name="secretary_mobile" id="secretary_mobile" class="validate[required]" type="text" maxlength="11" />-->
    <!--                    </div>-->
    <!--                </td>-->
    <!--            </tr>-->
    <!---->
...
<div class="box round first">
    ...
    <div class="block" id="entrepreneur_list">
        <table class="signup table" width="100%">
            <tbody>
                <tr>
                    <td class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('ENTREPRENEUR_TYPE');?></span><span style="color: #FF0000">*</span></td>
                    <td  class="custom fieldcella">
                ...
                <tr>
                    ...
                    <td width="29%" class="custom fieldcell">
                        <div class="input text">
                            <input name="entrepreneur_mobile" id="entrepreneur_mobile" class="validate[required]" type="text" maxlength="11" />
                        </div>
                    </td>
                    <td width="20%" class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('EMAIL');?> <span style="color: #FF0000">*</span></span></td>
                    <td width="29%" class="custom fieldcell">
                    ...
                    <td width="29%" class="custom fieldcell">
                        <div class="input select">
                            <select name="entrepreneur_sex" id="entrepreneur_sex" class="selectbox-1 validate[required]">
                                <option value=""><?php echo $this->lang->line('SELECT')?></option>
                                <option value="<?php echo $this->config->item('GENDER_MALE');?>"><?php echo $this->lang->line('MALE');?></option>
                                <option value="<?php echo $this->config->item('GENDER_FEMALE');?>"><?php echo $this->lang->line('FEMALE');?></option>
                            </select>
                        </div>
                    </td>
                    <td width="20%" class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('ADDRESS');?> <span style="color: #FF0000">*</span></span></td>
                ...
                <tr>
                    ...
                    <td width="29%" class="custom fieldcell">
                        <div class="input select">
                            <input name="entrepreneur_nid" id="entrepreneur_nid" class="validate[required]" type="text"/>
                        </div>
                    </td>
                    <td width="20%" class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('BANK_NAME');?> </span></td>
                    <td width="29%" class="custom fieldcell">
                        <div class="input textarea">
                            <input name="entrepreneur_bank_name" id="entrepreneur_bank_name" class="" type="text"/>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="29%" class="custom fieldcell">
                        <div class="input select">
                            <input name="entrepreneur_bank_account_no" id="entrepreneur_bank_account_no" class="validate[required]" type="text"/>
                        </div>
                    </td>
                    <td width="20%" class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('BANK_ACCOUNT_HOLDER_NAME');?> </span></td>
                    <td width="29%" class="custom fieldcell">
                        <div class="input textarea">
                            <input name="entrepreneur_bank_holder_name" id="entrepreneur_bank_holder_name" class="" type="text"/>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="29%" class="custom fieldcell">
                        <div class="input select">
                            <select name="entrepreneur_blog_member" id="entrepreneur_blog_member" class="selectbox-1 validate[required]">
                                <option value="<?php echo $this->config->item('STATUS_ACTIVE');?>"><?php echo $this->lang->line('YES');?></option>
                                <option value="<?php echo $this->config->item('STATUS_INACTIVE');?>"><?php echo $this->lang->line('NO');?></option>
                            </select>
                        </div>
                    </td>
                ...
                <tr>
                    <td class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('SECRET_QUESTION');?></span><span style="color: #FF0000">*</span></td>
                    <td  class="custom fieldcell">
                        <div class="input select">
                ...
                <tr>
                    <td class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('USER_PROFILE_PIC');?></span><span style="color: #FF0000">*</span></td>
                    <td  class="custom fieldcell">
                        <div class="input select">
    ...
    <div class="block ">
        <table class="signup table" width="100%">
            ...
            <tr>
                ...
                <td>
                    <div class="input select">
                        <input type="text" name="self_investment" id="self_investment" class="total_investment selectbox-1 validate[required] OnlyNumber" value=""  />
                    </div>
                </td>
                <td class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('INVEST_DEBT');?> <span style="color: #FF0000">*</span></td>
                <td>
                    <div class="input select">
                        <input type="text" name="invest_debt" id="invest_debt" class="total_investment selectbox-1 validate[required] OnlyNumber" value="" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="input select">
                        <input readonly type="text" name="invested_money" id="invested_money" class="selectbox-1 validate[required] OnlyNumber" value="" />
                    </div>
                </td>
...
<div class="box round first">
    ...
    <div class="block ">
        <table class="signup table" width="100%">
            <tbody>
            <tr>
                <td class="custom smalllabelcell"><span class="labelcell"><?php echo $this->lang->line('CONNECTION_TYPE');?></span><span style="color: #FF0000">*</span></td>
                <td>
                    <div class="input select">
...
<div class="box round first">
    ...
    <table class="signup table" width="100%">
        <tr>
            <td class="custom labelcell" style="text-align: center;">
                <input type="submit" style="cursor:pointer;" class="myButton" id="submitRegistration" name="submitRegistration" value="<?php echo $this->lang->line('SAVE');?>" />
            </td>
        </tr>
    </table>
</div>
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $(document).on("change",".entrepreneur_type",function()
        {
            ...
            if($(this).val()==<?php echo $this->config->item('ONLINE_CITY_CORPORATION_WORD_GROUP_ID');?>)
            {
                ...
                $("#uisc_name").html("<option value=''>"+Select+"</option>");
            }
        ...
        $(document).on("change","#user_division_id",function()
        {
            ...
            {
                $.ajax({
                    url: '<?php echo $CI->get_encoded_url('website/user_registration/get_zilla'); ?>',
                    type: 'POST',
                    dataType: "JSON",
        ...
        $(document).on("change","#user_zilla_id",function()
        {
            ...
            if(zilla_id>0)
            {
                ...
                {
                    $.ajax({
                        url: '<?php echo $CI->get_encoded_url('website/user_registration/get_upazila'); ?>',
                        type: 'POST',
                        dataType: "JSON",
                ...
                {
                    $.ajax({
                        url: '<?php echo $CI->get_encoded_url('website/user_registration/get_city_corporation'); ?>',
                        type: 'POST',
                        dataType: "JSON",
                        data:{division_id: $("#user_division_id").val(),zilla_id:zilla_id},
                        success: function (data, status)
                ...
                {
                    $.ajax({
                        url: '<?php echo $CI->get_encoded_url('website/user_registration/get_municipal'); ?>',
                        type: 'POST',
                        dataType: "JSON",
                        data:{division_id: $("#user_division_id").val(),zilla_id:zilla_id},
                        success: function (data, status)
        ...
        $(document).on("change","#user_upazila_id",function()
        {
            ...
            {
                $.ajax({
                    url: '<?php echo $CI->get_encoded_url('website/user_registration/get_union'); ?>',
                    type: 'POST',
                    dataType: "JSON",
        ...
        $(document).on("change","#user_citycorporation_id",function()
        {
            ...
            {
                $.ajax({
                    url: '<?php echo $CI->get_encoded_url('website/user_registration/get_city_corporation_word'); ?>',
                    type: 'POST',
                    dataType: "JSON",
        ...
        $(document).on("change","#user_municipal_id",function()
        {
            ...
            {
                $.ajax({
                    url: '<?php echo $CI->get_encoded_url('website/user_registration/get_municipal_ward'); ?>',
                    type: 'POST',
                    dataType: "JSON",
        ...
        $(document).on("change","#user_unioun_id",function()
        {
            ...
            $.ajax({
                url: '<?php echo $CI->get_encoded_url('website/user_registration/getUnionServiceCenter'); ?>',
                type: 'POST',
                dataType: "JSON",
                data:{division_id: $("#user_division_id").val(),zilla_id:$("#user_zilla_id").val(), upazilla_id: $("#user_upazila_id").val(), union_id: $("#user_unioun_id").val()},
                success: function (data, status)
                {
        ...
        $(document).on("change","#user_city_corporation_ward_id",function()
        {
            ...
            $.ajax({
                url: '<?php echo $CI->get_encoded_url('website/user_registration/getCityServiceCenter'); ?>',
                type: 'POST',
                dataType: "JSON",
                data:{division_id: $("#user_division_id").val(),zilla_id:$("#user_zilla_id").val(), citycorporation_id: $("#user_citycorporation_id").val(), city_corporation_ward_id: $(this).val()},
                success: function (data, status)
                {
        ...
        $(document).on("change","#user_municipal_ward_id",function()
        {
            $("#uisc_name").html('');
            $.ajax({
                url: '<?php echo $CI->get_encoded_url('website/user_registration/getMunicipalServiceCenter'); ?>',
                type: 'POST',
                dataType: "JSON",
                data:{division_id: $("#user_division_id").val(),zilla_id:$("#user_zilla_id").val(), municipal_id: $("#user_municipal_id").val(), municipal_ward_id: $(this).val()},
                success: function (data, status)
                {
    ...
    function RowIncrementResource()
    {
        ...
        cell1.innerHTML = "<select name='res_id[]' id='res_id"+ExId+"' class='selectbox-1' style='width:90%'>\n\
        <option value=''><?php echo $this->lang->line('SELECT');?></option>\n\
        <?php
        ...
        ?></select><span style='color: #FF0000'><b> *</b></span>";
        var cell1 = row.insertCell(1);
        cell1.innerHTML = "<textarea name='res_detail[]' id='res_detail[]' class='' style='width:90%'></textarea><span style='color: #FF0000'><b> *</b></span>";
        var cell1 = row.insertCell(2);
        cell1.innerHTML = "<input name='quantity[]' id='quantity[]' class='' type='text' style='width:90%'/><span style='color: #FF0000'><b> *</b></span>";
        var cell1 = row.insertCell(3);
        cell1.innerHTML = "<select name='status[]' id='status[]' class='selectbox-1 validate[required]' style='width:90%'>\n\
        <option value=''><?php echo $this->lang->line('SELECT');?></option>\n\
    ...
    function RowIncrementTraining()
    {
        ...
        cell1.innerHTML = "<select name='training_course[]' id='training_course"+ExId+"' class='selectbox-1'>\n\
            ...
            ?></select><span style='color: #FF0000'><b> *</b></span>";
        var cell1 = row.insertCell(1);
        cell1.innerHTML = "<input type='text' name='training_institute[]' id='training_institute[]' class='' /><span style='color: #FF0000'><b> *</b></span>";
        var cell1 = row.insertCell(2);
        cell1.innerHTML = "<input name='training_time[]' id='training_time[]' class='' type='text'/><span style='color: #FF0000'><b> *</b></span>";
